...
//	String sql_portInsert="insert into portfolio values((select nvl(max(portNum),0)+1 from portfolio),?,?,?,?,sysdate)";
	...
	public boolean portDelete(PortfolioVO vo) {
		   ...
		   try {
			...
			System.out.println("PortfolioDAO portDelete()�뿉�꽌 臾몄젣諛쒖깮!");
			e.printStackTrace();
			return false;
		}
		   return true;
	...
	public ArrayList<PortfolioVO> portSelectAll(){ 
	    ...
	    try {
	       ...
	       System.out.println("PortDAO portSelectAll()�뿉�꽌 臾몄젣諛쒖깮!");
	       e.printStackTrace();
	    }  
	    return portData;
	 }	
...
//		System.out.println("DAO 정상작동");
	...
	public boolean replyInsert(ReplyVO vo) {
	      ...
	      try {
	         ...
	         System.out.println("PortfolioDAO replyInsert()�뿉�꽌 臾몄젣諛쒖깮!");
	         e.printStackTrace();
	         return false;
	      } 
	      return true;
  ...
  try {
     ...
     pstmt.executeUpdate();
  	...
  	System.out.println("PortfolioDAO replyDelete()�뿉�꽌 臾몄젣諛쒖깮!");
	    e.printStackTrace();
	    return false;
  } 
	    return true;
