		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-4">
					<h2 class="heading-section"><a href="main.jsp">Home</a></h2>
				</div>
			</div>
					...
					<div class="table-wrap">
						<table class="table myaccordion table-hover" id="accordion">
						  ...
						  <tbody>
						    ...
						    <tr data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
						    ...
						    <tr>
						    	<td colspan="6" id="collapseOne" class="collapse show acc" data-parent="#accordion">
						    		<p><c:out value="${c.contactContent}"/></p>
						    	</td>
						    </tr>
							</c:forEach>
						  </tbody>
