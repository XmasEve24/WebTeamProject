...
function initialize() {
    var mapOptions = {
      zoom: 16,
      center: new google.maps.LatLng(37.500985178055, 127.03080390876369),
      scrollwheel: false
    };
...
function loadGoogleMap(){
    ...
    script.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyCwoWN3G8X9G_aZuEIe38RnqFgf3ilaloQ&callback=initMap&region=kr"&' + 'callback=initialize';
