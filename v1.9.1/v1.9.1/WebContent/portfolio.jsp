	...
	<div class="container">
		<div class="row">
          ...
          <div class="header-thumb">
              <h1 class="wow fadeIn" data-wow-delay="0.6s">Detail portfolio</h1>
         ...
         <div class="wow fadeInUp col-md-offset-1 col-md-10 col-sm-offset-1 col-sm-10" data-wow-delay="2.3s">
         	   ...
         	   <c:set var="pOne" value="${portSelectOne}"/>        		         		   
         		<c:set var="p" value="${pOne.port}" />    
         	  	...
         	  	<c:if test="${adminId != null}">
					<a href="deletePortfolio.do?portNum=${p.portNum }">DELETE</a>
				</c:if>
                 ...
                 <h3>Comments</h3>
                    <div class="media">
                      ...
                      <div class="media-body">
                        ...
                        <h5>${r.replyTime }  </h5>
                        <p>${r.replyContent }</p>
                        <c:if test="${memberName == r.memberName || adminId !=null}">
							<p align="right"><a href="deleteReply.do?replyNum=${r.replyNum}&portNum=${p.portNum}">[DELETE]</a></p>
						</c:if>
               ...
               <div class="blog-comment-form">
                  <h3>Leave a comment</h3>
                    ...
                    <input type="hidden" name="portNum" value="${p.portNum}">
